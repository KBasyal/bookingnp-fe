...
//                     console.log("The hotels belonging to this type are:", response);
//                     setHotels(response.result); // Assuming response.result contains the hotels
//                 }
//             } catch (error) {
...
//                     Hotels of Type: {type ? decodeURIComponent(type) : 'Unknown'}
//                 </h2>
//                 <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
//                     {hotels.map((hotel) => (
//                         <div key={hotel._id} className="group block overflow-hidden rounded-lg shadow-lg">

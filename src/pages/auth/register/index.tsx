                ...
                <div className="max-w-xl p-8 rounded-lg shadow-lg">
                    ...
                    <form action="#" className="space-y-6">
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-4">
                            <button
                                type="submit"
                                className="inline-block rounded-md border border-blue-600 bg-blue-600 px-6 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 active:text-blue-500"
                            >
                                Create an account
                            </button>
